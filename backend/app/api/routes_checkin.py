    ...
    for row in rows:
        ...
        out.append(
            CheckinHistoryItem(
                ...
                exercise_minutes_today=float(lifestyle.get("exercise_minutes_today")) if lifestyle.get("exercise_minutes_today") is not None else None,
                daylight_minutes_today=float(lifestyle.get("daylight_minutes_today")) if lifestyle.get("daylight_minutes_today") is not None else None,
                screen_time_min_today=float(lifestyle.get("screen_time_min_today")) if lifestyle.get("screen_time_min_today") is not None else None,
                ...
                sleep_onset_latency_min_today=float(lifestyle.get("sleep_onset_latency_min_today")) if lifestyle.get("sleep_onset_latency_min_today") is not None else None,
